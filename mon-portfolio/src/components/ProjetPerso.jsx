...
function ProjetPerso() {
  ...
  const projets = [
    { 
      ...
      description: 'DÉVELOPPEMENT D’UNE APPLICATION MOBILE ANDROID POUR PORTFOLIO, PERMETTANT D’ENREGISTRER LA FICHE D’UN PERSONNAGE, À LA MANIÈRE DE DONJONS ET DRAGONS.' 
    }
  ];
